          ...
          <div class="container">
            ...
            <div class="qr-layout">
              <section class="card stack">
                ...
                <div>
                  <h2>เลือกพื้นที่</h2>
                  <p class="subhead">เลือก area แล้วสร้าง QR ใหม่ได้ทันที</p>
                </div>

                <div class="field">
                  <label>Area</label>
                  <select v-model="selectedId" @change="buildQR">
                ...
                <div class="actions">
                  ...
                  <button class="btn ghost" @click="reloadAreas">รีเฟรชพื้นที่</button>
                </div>
